...
// Package types represents the imported interface "wasi:http/types@0.2.6".
//
...
import (
	monotonicclock "go-http/wasi/clocks/monotonic-clock"
	ioerror "go-http/wasi/io/error"
	"go-http/wasi/io/poll"
	"go-http/wasi/io/streams"
	"go.bytecodealliance.org/cm"
)

// Duration represents the type alias "wasi:http/types@0.2.6#duration".
//
// See [monotonicclock.Duration] for more information.
type Duration = monotonicclock.Duration

// InputStream represents the imported type alias "wasi:http/types@0.2.6#input-stream".
//
// See [streams.InputStream] for more information.
type InputStream = streams.InputStream

// OutputStream represents the imported type alias "wasi:http/types@0.2.6#output-stream".
//
// See [streams.OutputStream] for more information.
type OutputStream = streams.OutputStream

// IOError represents the imported type alias "wasi:http/types@0.2.6#io-error".
//
// See [ioerror.Error] for more information.
type IOError = ioerror.Error

// Pollable represents the imported type alias "wasi:http/types@0.2.6#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Method represents the variant "wasi:http/types@0.2.6#method".
//
...
// Scheme represents the variant "wasi:http/types@0.2.6#scheme".
//
...
// DNSErrorPayload represents the record "wasi:http/types@0.2.6#DNS-error-payload".
//
...
// TLSAlertReceivedPayload represents the record "wasi:http/types@0.2.6#TLS-alert-received-payload".
//
...
// FieldSizePayload represents the record "wasi:http/types@0.2.6#field-size-payload".
//
...
// ErrorCode represents the variant "wasi:http/types@0.2.6#error-code".
//
...
// HeaderError represents the variant "wasi:http/types@0.2.6#header-error".
//
...
// FieldKey represents the string "wasi:http/types@0.2.6#field-key".
//
...
// FieldName represents the type alias "wasi:http/types@0.2.6#field-name".
//
// See [FieldKey] for more information.
type FieldName = FieldKey

// FieldValue represents the list "wasi:http/types@0.2.6#field-value".
//
...
// Fields represents the imported resource "wasi:http/types@0.2.6#fields".
//
...
// Headers represents the imported type alias "wasi:http/types@0.2.6#headers".
//
// See [Fields] for more information.
type Headers = Fields

// Trailers represents the imported type alias "wasi:http/types@0.2.6#trailers".
//
// See [Fields] for more information.
type Trailers = Fields

// IncomingRequest represents the imported resource "wasi:http/types@0.2.6#incoming-request".
//
...
// OutgoingRequest represents the imported resource "wasi:http/types@0.2.6#outgoing-request".
//
...
// RequestOptions represents the imported resource "wasi:http/types@0.2.6#request-options".
//
...
// ResponseOutparam represents the imported resource "wasi:http/types@0.2.6#response-outparam".
//
...
// StatusCode represents the u16 "wasi:http/types@0.2.6#status-code".
//
...
// IncomingResponse represents the imported resource "wasi:http/types@0.2.6#incoming-response".
//
...
// IncomingBody represents the imported resource "wasi:http/types@0.2.6#incoming-body".
//
...
// FutureTrailers represents the imported resource "wasi:http/types@0.2.6#future-trailers".
//
...
// OutgoingResponse represents the imported resource "wasi:http/types@0.2.6#outgoing-response".
//
...
// OutgoingBody represents the imported resource "wasi:http/types@0.2.6#outgoing-body".
//
...
// FutureIncomingResponse represents the imported resource "wasi:http/types@0.2.6#future-incoming-response".
//
