...
// Package outgoinghandler represents the imported interface "wasi:http/outgoing-handler@0.2.6".
//
...
// OutgoingRequest represents the imported type alias "wasi:http/outgoing-handler@0.2.6#outgoing-request".
//
// See [types.OutgoingRequest] for more information.
type OutgoingRequest = types.OutgoingRequest

// RequestOptions represents the imported type alias "wasi:http/outgoing-handler@0.2.6#request-options".
//
// See [types.RequestOptions] for more information.
type RequestOptions = types.RequestOptions

// FutureIncomingResponse represents the imported type alias "wasi:http/outgoing-handler@0.2.6#future-incoming-response".
//
// See [types.FutureIncomingResponse] for more information.
type FutureIncomingResponse = types.FutureIncomingResponse

// ErrorCode represents the type alias "wasi:http/outgoing-handler@0.2.6#error-code".
//
