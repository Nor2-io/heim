...
Triggers in Heim decides how the application should be executed how under what premise.<br />
We currently doesn't support a mix of different triggers in a single Heim-application, but you can have x number of the same trigger in a application if its Cron- or a Http-trigger.

You also have a limitation of how many applications you can have with a Cron or Job-trigger as well, and this [Organization-limits](./../../../organization/limits/) can be found under your Organization in Heim-portal.
...
* **timeout**: execution-timeout in seconds, max allowed value is bounded [Organization-limits](./../../../organization/limits/)
...
Required fields:
* **timeout**: execution-timeout in seconds, max allowed value is bounded [Organization-limits](./../../../organization/limits/)
* **allow_parallel**: if you allow running multiple instance of queued works on the same node, most use-cases this should be true.
