...
Triggers in Heim decides how the application should be executed and under what premise.<br />
...
Job triggers are a work-load that only gets executed on-command, so each execution gets queued up  either by API or through Heim-portal.<br />
