...
sidebar:
  label: Component.toml
  order: 9
---

A NorNor Heim component.toml file is used to define a *component*. This component will be used to create an *application* in the Heim tool.
