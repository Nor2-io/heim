...
<Steps>
    <ol>
        ...
        <li>
            ...
            The [application.toml](./../../../application/config/applicationtoml/) is what defines an application. An application.toml is required for deploying an application to Heim.
