...
In the beta version of Heim, the Heim portal has limited functionality, primarily offering application-related read-only views.

In future versions of Heim, the currently deactivated options you'll find in the Heim sidebar will become available, and you'll be able to edit, create and delete applications, and much more.
:::
...
:::caution[beta version]
In the beta version of Heim, you'll be working with a placeholder organization: "localhost"
:::
...
:::caution[beta version]
The beta version of Heim allows for a local installation only. Login and authentication are currently not used or respected when running Heim locally
:::
...
:::note[beta version]
In the beta version of Heim, the Discord server is a means for the Heim team to collect valuable feedback.
...
:::caution[beta version]
In the beta version of Heim, you'll primarily be working with a placeholder project: "localhost"
:::
...
:::caution[beta version]
In the beta version of Heim, the information displayed on the Dashboard is read-only.

In future versions of Heim, you'll be able to edit scaling and trigger settings on this tab.
:::
...
:::caution[beta version]
The filter also comes with a step selector, made for controlling the precision of the respective graphs, giving you the option to collate data by minute, by hour, or by day.

This selector is currently non-functional.
:::
...
:::caution[beta version]
In future versions of Heim, the context menu will include a working rollback button for non-active versions.

Using the rollback button will roll back the application to the selected version.
:::
...
:::caution[beta version]
Much of the Heim CLI and Heim portal functionality will be expanded upon in future versions of Heim.

Currently, the Heim portal functionality is limited mainly to read-only data. In future versions of Heim, many more pages and features will be unlocked.
:::
