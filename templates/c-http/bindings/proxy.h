...
typedef struct wasi_http_types_dns_error_payload_t {
  proxy_option_string_t   rcode;
  proxy_option_u16_t   info_code;
...
typedef struct wasi_http_types_tls_alert_received_payload_t {
  proxy_option_u8_t   alert_id;
  proxy_option_string_t   alert_message;
...
typedef struct wasi_http_types_field_size_payload_t {
  proxy_option_string_t   field_name;
  proxy_option_u32_t   field_size;
...
typedef struct wasi_http_types_error_code_t {
  ...
  union {
    ...
    proxy_option_u64_t     http_request_body_size;
    proxy_option_u32_t     http_request_header_section_size;
    wasi_http_types_option_field_size_payload_t     http_request_header_size;
    proxy_option_u32_t     http_request_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_request_trailer_size;
    proxy_option_u32_t     http_response_header_section_size;
    wasi_http_types_field_size_payload_t     http_response_header_size;
    proxy_option_u64_t     http_response_body_size;
    proxy_option_u32_t     http_response_trailer_section_size;
    wasi_http_types_field_size_payload_t     http_response_trailer_size;
    proxy_option_string_t     http_response_transfer_coding;
    proxy_option_string_t     http_response_content_coding;
    proxy_option_string_t     internal_error;
  } val;
...
typedef proxy_string_t wasi_http_types_field_key_t;
...
} proxy_tuple2_field_name_field_value_t;

typedef struct {
  proxy_tuple2_field_name_field_value_t *ptr;
  size_t len;
} proxy_list_tuple2_field_name_field_value_t;
...
// being ready for I/O.
extern void wasi_io_poll_poll(wasi_io_poll_list_borrow_pollable_t *in, proxy_list_u32_t *ret);
...
// data.
extern void wasi_random_random_get_random_bytes(uint64_t len, proxy_list_u8_t *ret);
...
// hazard.
extern void wasi_io_error_method_error_to_debug_string(wasi_io_error_borrow_error_t self, proxy_string_t *ret);
...
extern bool wasi_io_streams_method_input_stream_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, proxy_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
// Read bytes from a stream, after blocking until at least one byte can
// be read. Except for blocking, behavior is identical to `read`.
extern bool wasi_io_streams_method_input_stream_blocking_read(wasi_io_streams_borrow_input_stream_t self, uint64_t len, proxy_list_u8_t *ret, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_io_streams_method_output_stream_write(wasi_io_streams_borrow_output_stream_t self, proxy_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
// ```
extern bool wasi_io_streams_method_output_stream_blocking_write_and_flush(wasi_io_streams_borrow_output_stream_t self, proxy_list_u8_t *contents, wasi_io_streams_stream_error_t *err);
...
extern bool wasi_http_types_static_fields_from_list(proxy_list_tuple2_field_name_field_value_t *entries, wasi_http_types_own_fields_t *ret, wasi_http_types_header_error_t *err);
// Get all of the values corresponding to a name. If the name is not present
// in this `fields` or is syntactically invalid, an empty list is returned.
// However, if the name is present but empty, this is represented by a list
// with one or more empty field-values present.
extern void wasi_http_types_method_fields_get(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, proxy_list_field_value_t *ret);
...
extern bool wasi_http_types_method_fields_set(wasi_http_types_borrow_fields_t self, wasi_http_types_field_name_t *name, proxy_list_field_value_t *value, wasi_http_types_header_error_t *err);
...
extern void wasi_http_types_method_fields_entries(wasi_http_types_borrow_fields_t self, proxy_list_tuple2_field_name_field_value_t *ret);
...
extern bool wasi_http_types_method_incoming_request_path_with_query(wasi_http_types_borrow_incoming_request_t self, proxy_string_t *ret);
...
extern bool wasi_http_types_method_incoming_request_authority(wasi_http_types_borrow_incoming_request_t self, proxy_string_t *ret);
...
extern bool wasi_http_types_method_outgoing_request_path_with_query(wasi_http_types_borrow_outgoing_request_t self, proxy_string_t *ret);
// Set the combination of the HTTP Path and Query for the Request.
// When `none`, this represents an empty Path and empty Query. Fails is the
// string given is not a syntactically valid path and query uri component.
extern bool wasi_http_types_method_outgoing_request_set_path_with_query(wasi_http_types_borrow_outgoing_request_t self, proxy_string_t *maybe_path_with_query);
...
extern bool wasi_http_types_method_outgoing_request_authority(wasi_http_types_borrow_outgoing_request_t self, proxy_string_t *ret);
// Set the authority of the Request's target URI. A value of `none` may be used
// with Related Schemes which do not require an authority. The HTTP and
// HTTPS schemes always require an authority. Fails if the string given is
// not a syntactically valid URI authority.
extern bool wasi_http_types_method_outgoing_request_set_authority(wasi_http_types_borrow_outgoing_request_t self, proxy_string_t *maybe_authority);
// Get the headers associated with the Request.
// 
// The returned `headers` resource is immutable: `set`, `append`, and
// `delete` operations will fail with `header-error.immutable`.
